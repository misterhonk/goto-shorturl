 ...
 *
 *  Bootstrap, Datenmodell und gemeinsame Helfer kommen aus lib.php.
 *  Klicks (clicks.json):  { "slug": { "t":gesamt, "d":{ "tag":n } } }
 *  – reine Zähler, DSGVO-konform, keine IPs / Zeitstempel / User-Agents.
 * ------------------------------------------------------------------ */

require __DIR__ . '/lib.php';   // Bootstrap ($cfg, $dataDir, Konstanten) + Helfer

// Nur im Admin genutzte Dateien und Optionen.
